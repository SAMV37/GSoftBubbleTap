...
public class level_4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int marginButt = (height - marginButton) - width5rd - 200;
...
//
//        b5.setX(0);
//        b5.setY(marginButt - width5rd);
//
//        b6.setX(width5rd);
//        b6.setY(marginButt - width5rd);
//
//        b7.setX(width5rd * 2);
//        b7.setY(marginButt - width5rd);
//
//        b8.setX(width5rd * 3);
//        b8.setY(marginButt - width5rd);
//
//        b9.setX(0);
//        b9.setY(marginButt - width5rd*2);
//
//        b10.setX(width5rd);
//        b10.setY(marginButt - width5rd*2);
//
//        b11.setX(width5rd * 2);
//        b11.setY(marginButt - width5rd*2);
//
//        b12.setX(width5rd * 3);
//        b12.setY(marginButt - width5rd*2);
//
//        b13.setX(0);
//        b13.setY(marginButt - width5rd*3);
//
//        b14.setX(width5rd);
//        b14.setY(marginButt - width5rd*3);
//
//        b15.setX(width5rd * 2);
//        b15.setY(marginButt - width5rd*3);
//
//        b16.setX(width5rd * 3);
//        b16.setY(marginButt - width5rd*3);

        layout_b1.setX(mejtex);
        layout_b1.setY(marginButt);

        layout_b2.setX(width5rd + mejtex*2);
        layout_b2.setY(marginButt);

        layout_b3.setX((width5rd * 2) + mejtex*3);
        layout_b3.setY(marginButt);

        layout_b4.setX((width5rd * 3) + mejtex*4);
        layout_b4.setY(marginButt);

        layout_b5.setX(mejtex);
        layout_b5.setY(marginButt - width5rd - mejtex);

        layout_b6.setX(width5rd + mejtex*2);
        layout_b6.setY(marginButt - width5rd - mejtex);

        layout_b7.setX((width5rd * 2) + mejtex*3);
        layout_b7.setY(marginButt - width5rd - mejtex);

        layout_b8.setX((width5rd * 3) + mejtex*4);
        layout_b8.setY(marginButt - width5rd - mejtex);

        layout_b9.setX(mejtex);
        layout_b9.setY(marginButt-(width5rd*2) - mejtex*2);

        layout_b10.setX(width5rd + mejtex*2);
        layout_b10.setY(marginButt-(width5rd*2) - mejtex*2);

        layout_b11.setX((width5rd * 2) + mejtex*3);
        layout_b11.setY(marginButt-(width5rd*2) - mejtex*2);

        layout_b12.setX((width5rd * 3) + mejtex*4);
        layout_b12.setY(marginButt-(width5rd*2) - mejtex*2);

        layout_b13.setX(mejtex);
        layout_b13.setY(marginButt-(width5rd*3) - mejtex*3);

        layout_b14.setX(width5rd + mejtex*2);
        layout_b14.setY(marginButt-(width5rd*3) - mejtex*3);

        layout_b15.setX((width5rd * 2) + mejtex*3);
        layout_b15.setY(marginButt-(width5rd*3) - mejtex*3);

        layout_b16.setX((width5rd * 3) + mejtex*4);
        layout_b16.setY(marginButt-(width5rd*3) - mejtex*3);
    }
    ...
    public void rnum() {
        ...
        randomNumber = r.nextInt(4 - 0) + 1;

        switch (randomNumber){
            case 1:
                   show.setBackground(this.getResources().getDrawable(R.drawable.bubble_red));
                    break;
            case 2:
                show.setBackground(this.getResources().getDrawable(R.drawable.bubble_green));
                break;
            case 3:
                show.setBackground(this.getResources().getDrawable(R.drawable.bubble_blue));
                break;
            case 4:
                show.setBackground(this.getResources().getDrawable(R.drawable.bubble_yellow));
                break;
        ...
        /////////////Nkarum e myus kochaknery 1 depqum
        if(randomNumber == 1) {
        ...
        ////////Nkarum e myus kochaknery 2 depqum
        if(randomNumber == 2) {
            if (num1 != 1 && num2 != 1 && num3 != 1) {
                int n = r.nextInt(4 - 1) + 1;
                if (n == 1) {
        ...
        /////////////////Nkarum e myus kochaknery 3 depqum
        if(randomNumber == 3) {
            if (num1 != 1 && num2 != 1 && num3 != 1) {
                int n = r.nextInt(4 - 1) + 1;
                if (n == 1) {
        ...
        /////////Nkarum e myus kochaknery 4 depqum
        if(randomNumber == 4) {
            if (num1 != 1 && num2 != 1 && num3 != 1) {
                int n = r.nextInt(4 - 1) + 1;
                if (n == 1) {
    ...
    public void onb1(View v) {
        if (pnum1 == 1 || pnum2 == 1 || pnum3 == 1) {
            ...
            if(started != false) {
                Intent i = new Intent(level_4.this, level_4_lost.class);
